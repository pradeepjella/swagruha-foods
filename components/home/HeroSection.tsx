...
export default function HeroSection() {
  return (
    <section className="hero-royal-bg relative w-full overflow-hidden">
      ...
      >
        {/* =======================================================
            TOP / MOBILE HERO AREA
            TEXT + IMAGE SIDE BY SIDE ON MOBILE
        ======================================================= */}
        ...
        <div className="relative lg:contents">
          ...
          >
            <div className="w-full lg:max-w-[620px]">
              {/* Mobile: Text and Image container */}
              <div className="grid grid-cols-[1.05fr_0.95fr] items-center gap-1 lg:block">
                {/* LEFT CONTENT */}
                <div className="text-left">
                  ...
                  <motion.div
                    ...
                    className="mb-3 flex items-center gap-2 sm:mb-5 sm:gap-3"
                  >
                    <span className="h-px w-4 bg-[#C99A2E] sm:w-8" />

                    <span className="font-sans text-[8px] font-semibold uppercase tracking-[0.18em] text-[#A67819] sm:text-xs sm:tracking-[0.28em]">
                      Happy
                    </span>
                  ...
                  <motion.p
                    ...
                    "
                  >
                    Traditional homemade flavors made with love for
              ...
              <div className="hidden lg:block">
                ...
                <motion.p
                  ...
                  className="mt-5 max-w-[540px] font-sans text-[16px] leading-7 text-[#26344A]"
                >
      ...
      {/* BENEFITS */}
      <div className="relative z-20 mx-auto w-full max-w-[1600px] px-5 pb-8 sm:px-10 lg:-mt-20 lg:px-14 xl:px-20">
        <motion.div
          initial={{ opacity: 0, y: 15 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{
          ...
          {benefits.map((benefit, index) => {
            ...
            return (
              <div
                ...
                className={`flex flex-col items-center gap-1 px-1 py-2 text-center sm:gap-2 sm:px-3 ${
                  index !== 0
              ...
              >
                ...
                <div>
                  ...
                  <p className="font-sans text-[7px] font-medium uppercase tracking-[0.03em] text-[#596579] sm:text-[10px]">
                    {benefit.subtitle}
                  </p>
                </div>
              </div>
